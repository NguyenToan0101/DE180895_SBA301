...
export default function AddCarModal({ onClose, onSubmit }: AddCarModalProps) {
    ...
    <Dialog open onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Enter the details of the new car. All fields are required.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4">
          ...
          <p className="text-xs text-muted-foreground">
            ✓ CreatedAt will be set to current date automatically
          </p>
        </div>
